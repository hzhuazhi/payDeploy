            ...
            <ul>
                ...
                <li style="border-top: none;">
                    <div class="formTextDiv">
                        <span class="require" >代理名称</span>
                    </div>
                    <div class="formCtrlDiv">
                        <input type="text" class="formInput" id="agentName" name="agentName" value="${dl.agentName}" disabled maxlength="240" />
                    </div>
                </li>
                <li style="border-top: none;">
                    <div class="formTextDiv">
    ...
    $(function(){
        ...
        $("#addSupplierForm").validate({
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    url : ctx+ "/withdrawagentcheck/update.do",
                    type : 'post',
                    dataType : 'json',
                    data :formData,
                    success : function(data) {
                        if (data.success) {
                            alert("审核成功！");
                            window.location.href = ctx + "/withdrawagentcheck/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
