...
<script type='text/javascript' charset="utf-8" src='${ctxData}js/manager/withdrawagent/withdrawagent.js'></script>
            ...
            submitHandler : function() {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        if (data.success) {
                            alert("添加成功！！！");
                            window.location.href = ctx + "/withdrawagent/list.do";
                        } else {
                            art.alert(data.msg);
                        }
                    },
