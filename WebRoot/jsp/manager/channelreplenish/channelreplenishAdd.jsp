...
<div class="col_main">
    ...
    <div class="formContentDiv">
        <form id="addSupplierForm" method="POST" enctype="multipart/form-data"
              action='${ctxData}channelreplenish/add.do'>
            ...
            <ul>
                ...
                <li>
                    <div class="" style="margin-bottom: 20px; margin-top: 20px;margin-left:200px;">
                        <input type="submit" class="buttonClass imginput" value="新 增" /> <span>
...
<script type='text/javascript'>
    ...
    //             $.ajax({
    //                 url : ctx+ "/channelreplenish/add.do",
    //                 type : 'post',
    //                 dataType : 'json',
    //                 data :formData,
    ...
    //                     if (data.success) {
    //                         alert("添加成功！！！");
    //                         window.location.href = ctx + "/channelreplenish/list.do";
    //                     } else {
    //                         art.alert(data.msg);
    //                     }
    //                 },
